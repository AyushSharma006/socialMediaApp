    ...
    <div className="w-[20rem] h-[calc(100vh-65px)] top-[65px] fixed">
      <div className="p-5">
        <ul className="flex flex-col gap-2">
          <Link
            to={"/"}
            className="flex flex-row gap-3 items-center font-extrabold cursor-pointer hover:bg-slate-50 p-2 rounded-lg"
          >
            <MdOutlineRssFeed className="text-xl" />{" "}
            <span className="font-semibold text-base">Feed</span>
          </Link>
          <Link
            to={"/chat"}
            className="flex flex-row gap-3 items-center font-extrabold cursor-pointer hover:bg-slate-50 p-2 rounded-lg"
          ...
          >
            ...
            <span className="font-semibold text-base">News</span>
          </Link>
        </ul>
      </div>
    </div>
